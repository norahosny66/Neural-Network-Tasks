...
def Plot_2_Classes():
    ...
    for x in six_combinations:
       Class1 = dataset.GetDataSet('Iris-setosa', [ feature_index[x[0]], feature_index[x[1]] ]).values
       Class2 = dataset.GetDataSet('Iris-versicolor', [ feature_index[x[0]], feature_index[x[1]] ]).values
       Class3 = dataset.GetDataSet('Iris-virginica', [ feature_index[x[0]], feature_index[x[1]] ]).values
